...
var app = new Vue({
    ...
    methods: {
        getSongLyrics: function getSongLyrics() {
            var _this = this;

            axios.get('/api/lyrics/99bottles?verses=' + this.numberOfVerses).then(function (response) {
                _this.lyrics = response.data.lyrics.replace(/\n/g, "<br />");
                _this.error = '';
            }).catch(function (response) {
                _this.error = 'There was a problem retrieving the songs lyrics.';
                _this.lyrics = '';
            });
        }
    }
